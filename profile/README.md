...
| 강민지[팀장]        | 구본석 | 남택호                                                 | 여승아 |
|----------------|--------|-----------------------------------------------------|--------|
| [프로필 이미지]      | [프로필 이미지] | <img src="/assets/members/Nam.jpg" width="100px" /> | [프로필 이미지] |
| [GitHub 링크 입력] | [GitHub 링크 입력] | [@NamTaekHo](https://github.com/NamTaekHo)          | [GitHub 링크 입력] |
...
| 로그인                                 | 회원가입 |
|-------------------------------------|------|
| <img src="./assets/app/Login.gif /> | 내용2  |
